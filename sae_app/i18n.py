...
TRANSLATIONS = {
    ...
    "es": {
        ...
        "CSV import summary: {read} row(s) read, {imported} imported, {unknown} unknown program(s), {duplicates} duplicate(s), {invalid} invalid row(s).": "Resumen de importación CSV: {read} fila(s) leída(s), {imported} importada(s), {unknown} programa(s) desconocido(s), {duplicates} duplicado(s), {invalid} fila(s) inválida(s).",
        ...
        "Some CSV rows could not be imported. Review the details below before importing the valid rows.": "Algunas filas del CSV no se pudieron importar. Revisa los detalles antes de importar las filas válidas.",
        ...
        "Import valid rows only": "Importar solo las filas válidas",
        "Replace current wish list with valid imported rows": "Reemplazar la lista actual con las filas válidas importadas",
        ...
        "Proximity uses program/commune coordinates when available. Regional centroids are only a soft fallback and are never used for hard distance exclusion. To improve precision, add data/commune_coordinates.csv with commune, region, latitude, longitude.": "La proximidad usa coordenadas del programa o de la comuna cuando están disponibles. Los centroides regionales son solo un respaldo suave y nunca se usan para una exclusión dura por distancia. Para mejorar la precisión, agrega data/commune_coordinates.csv con comuna, región, latitud y longitud.",
        ...
        "The {max_distance:.0f} km straight-line limit is applied only when the program has reliable school/commune coordinates. Regional approximations are never used for hard exclusion.": "El límite de {max_distance:.0f} km en línea recta se aplica solo cuando el programa tiene coordenadas confiables del establecimiento o de la comuna. Las aproximaciones regionales nunca se usan para una exclusión dura.",
