...
TRANSLATIONS = {
    ...
    "es": {
        ...
        "Import a preference list from CSV — optional": "Importar una lista de preferencias desde CSV — opcional",
        "This option is intended for families or researchers who already have a compatible file. Most families can build the list directly below.": "Esta opción está destinada a familias o investigadores que ya tienen un archivo compatible. La mayoría de las familias puede crear la lista directamente a continuación.",
        "Choose a wish-list CSV": "Elegir un CSV de preferencias",
        ...
        "Belongs to the 15% priority-student quota": "Pertenece al 15 % de estudiantes prioritarios",
        ...
        "Why it appears: it balances similarity to the current list, proximity and estimated risk reduction.": "Por qué aparece: equilibra la similitud con la lista actual, la proximidad y la reducción estimada del riesgo.",
        ...
        "Why do these suggestions match the current list?": "¿Por qué estas sugerencias coinciden con la lista actual?",
        "The app inferred the following recurring characteristics from the family's current preferences.": "La app identificó las siguientes características recurrentes en las preferencias actuales de la familia.",
